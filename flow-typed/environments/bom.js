...
declare class PerformanceObserver {
  constructor(
    callback: (entries: PerformanceObserverEntryList, observer: PerformanceObserver) => mixed
  ): void;
...
declare interface CredMgmtCredentialsContainer {
  ...
  create(creationOption?: CredMgmtCredentialCreationOptions): Promise<?CredMgmtCredential>;
