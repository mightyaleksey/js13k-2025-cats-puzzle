// flow-typed signature: 1bd62287ecb270bae3993d3995d90329
// flow-typed version: 988666c3d2/dom/flow_>=v0.261.x
...
declare class CustomEvent extends Event {
  ...
  // deprecated
  initCustomEvent(type: string, bubbles: boolean, cancelable: boolean, detail: any): CustomEvent;
}
...
declare class MouseEvent extends UIEvent {
  constructor(typeArg: string, mouseEventInit?: MouseEvent$MouseEventInit): void;
  altKey: boolean;
  button: number;
  buttons: number;
  clientX: number;
...
declare class PointerEvent extends MouseEvent {
  constructor(typeArg: string, pointerEventInit?: PointerEvent$PointerEventInit): void;
  pointerId: number;
  width: number;
  height: number;
  pressure: number;
...
declare class Document extends Node {
  ...
  createNodeIterator<RootNodeT: Document>(
    ...
    whatToShow: 901,
    filter?: NodeFilterInterface
  ): NodeIterator<RootNodeT, DocumentType | Document | Element | Text | Comment>;
