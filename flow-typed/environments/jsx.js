...
declare class SyntheticMouseEvent<+T: EventTarget = EventTarget, +E: Event = MouseEvent>
...
type ReactDOM$AriaAttributes = {|
  ...
  'aria-current'?: ?(ReactDOM$BooleanishString | 'page' | 'step' | 'location' | 'date' | 'time'),
  /**
  ...
  'aria-haspopup'?: ?(ReactDOM$BooleanishString | 'menu' | 'listbox' | 'tree' | 'grid' | 'dialog'),
  /**
...
type ReactDOM$HTMLAttributeAnchorTarget = '_self' | '_blank' | '_parent' | '_top'
