...
declare module 'child_process' {
  ...
  declare function execSync(command: string, options?: child_process$execSyncOpts): Buffer
...
type crypto$DiffieHellman = {
  computeSecret(other_public_key: string, input_encoding?: string, output_encoding?: string): any,
...
declare class crypto$ECDH {
  ...
  computeSecret(other_public_key: string, input_encoding: crypto$ECDH$Encoding): Buffer;
  computeSecret(
...
declare module 'crypto' {
  ...
  declare function createCredentials(details?: crypto$createCredentialsDetails): crypto$Credentials
  ...
  declare function privateDecrypt(private_key: crypto$key, buffer: Buffer): Buffer
  declare function privateEncrypt(private_key: crypto$key, buffer: Buffer): Buffer
  ...
  declare function randomBytes(size: number, callback: (err: ?Error, buffer: Buffer) => void): void
  ...
  declare function randomUUID(options?: $ReadOnly<{| disableEntropyCache?: boolean |}>): string
...
declare module 'dns' {
  ...
  declare function reverse(ip: string, callback: (err: ?Error, domains: Array<any>) => void): void
  declare function timingSafeEqual(
    a: Buffer | $TypedArray | DataView,
    b: Buffer | $TypedArray | DataView
  ): boolean
...
declare module 'readline' {
  ...
  declare function clearLine(stream: stream$Stream, dir: -1 | 1 | 0, callback?: () => void): void
  declare function clearScreenDown(stream: stream$Stream, callback?: () => void): void
...
declare module 'stream' {
  ...
  declare function finished(stream: stream$Stream, callback: (error?: Error) => void): () => void
...
declare module 'url' {
  ...
  declare class URLSearchParams {
    ...
    constructor(
      init?: string | URLSearchParams | Array<[string, string]> | { [string]: string, ... }
    ): void;
    append(name: string, value: string): void;
    delete(name: string, value?: void): void;
    entries(): Iterator<[string, string]>;
    forEach<This>(
      callback: (this: This, value: string, name: string, searchParams: URLSearchParams) => mixed,
      thisArg?: This
    ): void;
...
declare module 'util' {
  ...
  declare function parseArgs<TOptions: { [string]: util$ParseArgsOption } = {||}>(config: {|
    args?: Array<string>,
    options?: TOptions,
    strict?: boolean,
...
declare class Process extends events$EventEmitter {
  ...
  emitWarning(warning: string, type: string, code: string, ctor?: (...empty) => mixed): void;
  execArgv: Array<string>;
  execPath: string;
