...
export const zzfxG = (q = 1, k = 0.05, c = 220, e = 0, t = 0, u = 0.1, r = 0, F = 1, v = 0, z = 0, w = 0, A = 0, l = 0, B = 0, x = 0, G = 0, d = 0, y = 1, m = 0, C = 0) => {
  const b = 2 * Math.PI; const H = v *= 500 * b / zzfxR ** 2
  const I = (x > 0 ? 1 : -1) * b / 4; let D = c *= (1 + 2 * k * Math.random() - k) * b / zzfxR
  const Z = []
  let g = 0
  let E = 0
  let a = 0
