...
type SoundType = 'error' | 'match' | 'select'
...
export async function initSoundBank () {
  ...
  // prettier-ignore
  _soundBank.error = [0.6,, 30, 0.01, 0.04, 0.06, 2, 3.8, 3,,,,, 1.8,,,, 0.92, 0.03,, -2186]
  // prettier-ignore
  _soundBank.select = [0.8, 0, 630, 0.01, 0.01, 0.01, 1, 3.4, 0.1,,,,,,,, 0.2, 0.8, 0.01,, 564]
  // prettier-ignore
